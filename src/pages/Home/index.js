...
export function Home() {
  return (
    <div className="bg-amber-600 text-white h-screen">
      ...
      <div>
        <h3 className="font-bold mb-2 text-2xl mt-12 text-center">Qual o seu perfil?</h3>
      </div>
      <div className="flex-col text-center text-black mt-8 justify-center">
        ...
        <div>
          <Link to="/admin">
            <button
              className="
            items-center justify-center px-6 py-2 border border-transparent text-base font-medium mb-2 rounded-full  bg-purple-700 hover:bg-purple-400 transition ease-in-out delay-150 text-white font-bold hover:-translate-x-1 hover:scale-110  duration-300"
            >
              Nutricionista
            </button>
          </Link>
