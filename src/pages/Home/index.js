  ...
  return (
    <div className="bg-amber-600 text-white h-screen">
      ...
      <div className="flex-col text-center text-black mt-8 justify-center">
        <div>
          <Link to="/user">
            <button className="items-center justify-center px-9 py-2 border border-transparent text-base font-medium mb-2 rounded-full  bg-indigo-100 transition ease-in-out delay-150 hover:-translate-x-1 hover:scale-110 hover:bg-indigo-100 duration-300">
              Paciente
            </button>
          </Link>
        </div>
